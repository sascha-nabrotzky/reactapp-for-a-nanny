...
function Datenschutz() {
  return (
    <>
      <Helmet>
        <title>Datenschutz | Kindertagespflege Gänseblümchen</title>
        <meta
          name="description"
          content="Datenschutzerklärung der Kindertagespflege Gänseblümchen."
        />
      </Helmet>
      ...
      <main>
        ...
        <p>
          Ich freue mich sehr über Ihr Interesse an der Kindertagespflege.
          Datenschutz hat einen besonders hohen Stellenwert für die Tagesmutter
          Oksana Welk. Eine Nutzung der Internetseiten von Gänseblümchen
          Ladbergen ist grundsätzlich ohne jede Angabe personenbezogener Daten
        ...
        <p>
          ...
          und in Übereinstimmung mit den für Tagesmutter Oksana Welk geltenden
        ...
        <p>
          Tagesmutter Oksana Welk hat als für die Verarbeitung Verantwortlicher
        ...
        <p>
          Die Datenschutzerklärung von Tagesmutter Oksana Welk beruht auf den
        ...
        <p>
          Die Internetseite der Tagesmutter Oksana Welk erfasst mit jedem Aufruf
        ...
        <p>
          ...
          Tagesmutter Oksana Welk keine Rückschlüsse auf die betroffene Person.
          ...
          anonym erhobenen Daten und Informationen werden durch die Tagesmutter
          Oksana Welk daher einerseits statistisch und ferner mit dem Ziel
        ...
        <p>
          Auf der Website von Gänseblümchen Ladbergen ist kein Kontaktformular
          vorhanden. Besucher können über einen mailto-Link auf der Webseite
          Nachrichten an ihn übermitteln. Um eine Antwort empfangen zu können,
          ist zumindest die Angabe einer gültigen E-Mail-Adresse erforderlich.
          Alle weiteren Angaben kann die anfragende Person freiwillig geben. Mit
          Absenden der Nachricht über den jeweiligen E-Mail-Client willigt der
        ...
        <p>
          ...
          Aufbewahrung gegeben sind (z. B. anschließende Beauftragung unserer
          Kanzlei).
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            <p>
              ...
              bei der Tagesmutter Oksana Welk gespeichert sind, veranlassen
              ...
              Tagesmutter Oksana Welk wird veranlassen, dass dem Löschverlangen
              unverzüglich nachgekommen wird.
            </p>

            <p>
              Wurden die personenbezogenen Daten von der Tagesmutter Oksana Welk
              öffentlich gemacht und ist unser Unternehmen als Verantwortlicher
              gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen
              Daten verpflichtet, so trifft die Tagesmutter Oksana Welk unter
              ...
              der Tagesmutter Oksana Welk wird im Einzelfall das Notwendige
              veranlassen.
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              Daten, die bei der Tagesmutter Oksana Welk gespeichert sind,
              verlangen möchte, kann sie sich hierzu jederzeit an einen
              Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der
              Mitarbeiter der Tagesmutter Oksana Welk wird die Einschränkung der
          ...
          <li>
            ...
            <p>
              ...
              Tagesmutter Oksana Welk wenden.
            </p>
          </li>
          <li>
            ...
            <p>
              Die Tagesmutter Oksana Welk verarbeitet die personenbezogenen
            ...
            <p>
              Verarbeitet die Tagesmutter Oksana Welk personenbezogene Daten, um
              ...
              Person gegenüber der Tagesmutter Oksana Welk der Verarbeitung für
              Zwecke der Direktwerbung, so wird die Tagesmutter Oksana Welk die
            ...
            <p>
              ...
              Verarbeitung personenbezogener Daten, die bei der Tagesmutter
              Oksana Welk zu wissenschaftlichen oder historischen
            ...
            <p>
              ...
              Person direkt an jeden Mitarbeiter der Tagesmutter Oksana Welk
          ...
          <li>
            ...
            <p>
              ...
              Tagesmutter Oksana Welk angemessene Maßnahmen, um die Rechte und
